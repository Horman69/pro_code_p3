...
export const Hero = () => {
  return (
    <section className="container flex flex-col lg:flex-row items-center justify-between py-20 md:py-32 gap-10" aria-label="Главный баннер PRO_CODE">
      <div className="text-center lg:text-start space-y-6">
        <header className="text-4xl sm:text-5xl md:text-6xl font-bold">
          <h1 className="mb-2">
            ...
            <span>детская онлайн-школа</span>
          </h1>
          <h2 className="inline">
        ...
        <div className="space-y-4 md:space-y-0 md:space-x-4">
          <Button 
            ...
            aria-label="Записаться на бесплатный урок в PRO_CODE"
          >
